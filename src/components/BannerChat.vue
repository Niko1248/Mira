...
>>>>>>> d4ce2347ea6d22f046e89a48b7e58db1d6097083

<template>
    <div class="chat">
        <div class="chat__wrapper" ref="chatWrapper">
            <transition name="fade-human" appear @after-enter="showGPTAfterDelay(currentChat)"
                @after-leave="startChat(currentChat)">
                <div class="chat__human" v-if="showHuman">
                    <div class="chat__human-ico ico">
                        <img :src="chatArray[this.currentChat].humanIco" alt="" />
                    </div>
                    <div class="chat__human-text text">
                        {{ chatArray[this.currentChat].humanText }}
                    </div>
            ...
            <transition name="fade-gpt">
                <div v-if="showGPT" class="chat__gpt">
                    <div class="chat__gpt-ico ico">
                        <img src="../assets/img/chat_avatars/ava_gpt.svg" alt="" />
                    </div>
...
=======
        ...
        typeWord() {
            if (this.currentIndex < this.words.length) {
                this.typedText += (this.typedText ? " " : "") + this.words[this.currentIndex];
                this.currentIndex++;
